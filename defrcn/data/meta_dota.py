...
__all__ = ["register_meta_dota"]


def load_dota_json(json_file, image_root, metadata, dataset_name):
...
def register_meta_dota(name, metadata, imgdir, annofile):
    DatasetCatalog.register(
        name,
        lambda: load_dota_json(annofile, imgdir, metadata, name),
    )
