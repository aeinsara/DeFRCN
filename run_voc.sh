...
EXP_NAME=$1
SAVE_DIR=checkpoints/voc/defrcn
...
# python3 main.py --num-gpus 1 --config-file configs/voc/defrcn_det_r101_base2.yaml --opts MODEL.WEIGHTS ImageNetPretrained/MSRA/R-101.pkl OUTPUT_DIR checkpoints/voc/1/defrcn_det_r101_base2
: '
# ------------------------------ Model Preparation -------------------------------- #
